...
train_dataloader = train_dataloader_bbbc
train_cfg = dict(
    type = "MultiDomainTrainLoop", 
    dataloader = train_dataloader,
    dataloaders_multi_domain = [train_dataloader_bbbc], 
    max_epochs = 50,
    val_interval = 5,
    _delete_ = True
)
...
val_dataloader = val_dataloader_bbbc
val_cfg = dict(#type = "ValLoop",
                type = "MultiDomainValLoop",
               dataloaders_multi_domain= [val_dataloader_bbbc],
               domain_names = ['BBBC041'])
...
test_dataloader = test_dataloader_bbbc
test_cfg = dict(type = "MultiDomainTestLoop",
                dataloaders_multi_domain = [test_dataloader_bbbc],
                domain_names = ['BBBC041'],
                )
...
default_hooks = dict(checkpoint=dict(type='CheckpointHook', interval=5, by_epoch=True,
                                    save_best = ['BBBC041/accuracy/top1',
                                                'BBBC041/recall/parasitized'],
